...
<body>
    ...
    <?php
        ...
        if($_SERVER['REQUEST_METHOD'] == 'POST')
        {
            ...
            else
            {
                ...
                $sql = "UPDATE `registered_user` SET `Name`='$name', `Email`='$email', `Password`='$password' WHERE `S. No.`='$userid'";
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            <form action="/lms/edit_profile.php" method="post" style="margin-left: 30px; margin-top: 50px;">
                <div class="mb-3 mt-5">
