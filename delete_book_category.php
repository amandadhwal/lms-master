  ...
  background-size: cover;">
    ...
    <div class="row">
        <div class="col-md-2">
            <div class="d-flex flex-column flex-shrink-0 p-3 bg-light" style="width: 280px; height: 100%">
                <ul class="nav nav-pills flex-column mb-auto">
                    ...
                    <hr>
                    <li>
                        <a href="delete_book_category.php" class="nav-link active">
                            <svg class="bi me-2" width="16" height="16">
                                <use xlink:href="#grid"></use>
                            </svg>
        ...
        <div class="col-md-8">
            ...
            <h3 class="text-center" style="margin-top: 70px; color: white;">Delete Book Category</h3>
            <form action="/lms/delete_book_category.php" method="post" style="margin-left: 30px; margin-top: 60px;">
                <div class="mb-5">
                ...
                <button class="w-100 btn" style="background-color: #7CF5F9;" type="submit">Delete Category</button>
            </form>
        </div>
        <div class="col-md-1"></div>
    </div>
