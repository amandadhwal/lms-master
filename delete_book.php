  ...
  background-size: cover;">
    ...
    <?php
        ...
        if($_SERVER['REQUEST_METHOD'] == 'POST')
        {
            ...
            {
                $sql = "SELECT * FROM `books` WHERE `Name` = '$book_name' AND `Author` = '$author_name'";
                ...
                if($result)
                {
                    ...
                    {
                        $sql = "DELETE FROM `books` WHERE `Name` = '$book_name' AND `Author` = '$author_name'";
                        $result = mysqli_query($conn, $sql);
                        if($result)
                        {
                    ...
                    {
                        echo '<div class="alert alert-primary alert-dismissible fade show" role="alert">
                            No such book is in the library.
                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                            </div>';
                    }
                }
    ...
    <div class="row">
        <div class="col-md-2">
            <div class="d-flex flex-column flex-shrink-0 p-3 bg-light" style="width: 280px; height: 100%">
                <ul class="nav nav-pills flex-column mb-auto">
                    ...
                    <hr>
                    <li>
                        <a href="delete_book.php" class="nav-link active">
                            <svg class="bi me-2" width="16" height="16">
        ...
        <div class="col-md-8">
            ...
            <h3 class="text-center" style="margin-top: 50px;">Delete Book</h3>
            <form action="/lms/delete_book.php" method="post" style="margin-left: 30px; margin-top: 60px;">
                <div class="mb-3">
                ...
                <button class="w-100 btn" style="background-color: #7CF5F9;" type="submit">Delete Book</button>
            </form>
        </div>
        <div class="col-md-1"></div>
    </div>
